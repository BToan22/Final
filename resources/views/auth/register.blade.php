			...
			<div class="form-outer text-center d-flex align-items-center">
				<div class="form-inner" style="width:100%">
				  <form method="post" action="{{route('register.post')}}" id="form-register" class="text-left">
					@csrf
					<center> <a href="{{route('home')}}">OCTEE</a></center>
					<br/>
					<div class="form-group-material">
					  	<input id="register-username" type="text" name="username" class="input-material">
					  	<label for="register-username" class="label-material"style="color:#4083ff">Họ và tên</label>
					...
					<div class="form-group-material">
						...
						<label for="register-email" class="label-material" style="color:#4083ff">Email</label>
					...
					<div class="form-group-material">
					  ...
					  <label for="register-password" class="label-material" style="color:#4083ff">Mật khẩu</label>
					...
					<div class="form-group-material">
						...
						<label for="register-confirm_password" class="label-material" style="color:#4083ff">Nhập lại mật khẩu</label>
