				...
				<div class="form-inner" style="width:100%">
				  <form method="post" id="form-login" class="text-left" action="{{route('login')}}">
					...
					<div class="form-group-material" >
					  ...
					  <label for="login-email" class="label-material" style="color:#4083ff">Email</label>
					...
					<div class="form-group-material">
					  ...
					  <label for="login-password" class="label-material" style="color:#4083ff">Mật khẩu</label>
					...
					<div class="form-group text-center">
						  <button style="submit" style="background-color:#4083ff;border-color:#FE980F" id="login" type="submit" class="btn btn-primary btn-custom">Đăng nhập</button>
